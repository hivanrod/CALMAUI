...
namespace Calendario2.Shared
{
    public class RepeticionComponentBase : ComponentBase
    {
        [Inject]
        ...
        [Parameter]
        public bool Repite { get; set; } = false;
        [Parameter]
        public Repeticion[] repeticiones { get; set; }
        [Parameter]
        public Tema[] temas { get; set; }
        [Parameter]
        public Repeticion[] repeticionesCitas { get; set; }
        [Parameter]
        public Repeticion[] repeticionesTareas { get; set; }
        [Parameter]
        ...
        [Parameter]
        public TipoRepeticion[] tipoRepeticiones { get; set; }
        [Parameter]
        public TipoRepeticion tipoRepeticion { get; set; }
        [Parameter]
        public TipoObjeto[] tipoObjetos { get; set; }
        [Parameter]
        ...
        // Edit
        [Parameter]
        public EditContext RepeticionEditContext { get; set; }
